...
// tm_leet - de_dust2, de_mirage
#define TM_LEET_HEAD_A	((Stride==32) && (NumVertices==3692) && (primCount==5699))	
#define TM_LEET_HEAD_B	((Stride==32) && (NumVertices==3225) && (primCount==4751))			
#define TM_LEET_HEAD_C	((Stride==32) && (NumVertices==2663) && (primCount==3856))				
#define TM_LEET_HEAD_DE ((Stride==32) && (NumVertices==3742) && (primCount==5672))			
#define TM_LEET_HEAD	( TM_LEET_HEAD_A || TM_LEET_HEAD_B || TM_LEET_HEAD_C || TM_LEET_HEAD_DE )

#define TM_LEET_BODY_A	((Stride==32) && (NumVertices==3845) && (primCount==5545))	
#define TM_LEET_BODY_B	((Stride==32) && (NumVertices==5008) && (primCount==6772))	
#define TM_LEET_BODY_C	((Stride==32) && (NumVertices==5572) && (primCount==8607)) 
#define TM_LEET_BODY_D	((Stride==32) && (NumVertices==4536) && (primCount==5963))	
#define TM_LEET_BODY_E	((Stride==32) && (NumVertices==5781) && (primCount==8207))	
#define TM_LEET_BODY	( TM_LEET_BODY_A || TM_LEET_BODY_B || TM_LEET_BODY_C || TM_LEET_BODY_D || TM_LEET_BODY_E )

#define TM_LEET_LBODY	((Stride==32) && (NumVertices==3932) && (primCount==5551)) 
#define TM_LEET_ARMS	((Stride==32) && (NumVertices==622) && (primCount==1104))	
#define TM_LEET_HANDS	((Stride==32) && (NumVertices==984) && (primCount==1466))	

#define TM_LEET			( TM_LEET_HEAD || TM_LEET_BODY || TM_LEET_LBODY || TM_LEET_ARMS || TM_LEET_HANDS )
...
//T Models
#define T_Models (t_elite || t_separatist || t_anarchist || t_professional || t_phoenix || t_balkan || t_pirate || TM_LEET)
